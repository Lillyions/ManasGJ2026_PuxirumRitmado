...
namespace Dypsloom.RhythmTimeline.Core
{
    ...
    {
        [Tooltip("The Color of the track used by certain special notes.")]
        [SerializeField] protected Color m_PrimaryColor = Color.white;
        [Tooltip("The Color of the track used by certain special notes.")]
        [SerializeField] protected Color m_SecondaryColor = Color.white;
        [Tooltip("The Color of the track used by certain special notes.")]
        [SerializeField] protected Color[] m_AdditionalColors;
        ...
        [SerializeField] private Material _trackMat;
        ...
        public Color[] AdditionalColors => m_AdditionalColors;

        public Material ShinyCircleMat => _trackMat;
