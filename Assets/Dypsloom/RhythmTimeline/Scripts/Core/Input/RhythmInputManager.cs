...
namespace Dypsloom.RhythmTimeline.Core.Input
{
    ...
    public class RhythmInputManager : MonoBehaviour
    {
        ...
        [SerializeField] protected SimpleInputActionKey[] m_TrackInput;
        [Tooltip("The key code to swipe left.")]
        [SerializeField] protected SimpleInputActionKey m_SwipeLeft;
        [Tooltip("The key code to swipe right.")]
        [SerializeField] protected SimpleInputActionKey m_SwipeRight;
        [Tooltip("The key code to swipe up.")]
        [SerializeField] protected SimpleInputActionKey m_SwipeUp;
        [Tooltip("The key code to swipe down.")]
        [SerializeField] protected SimpleInputActionKey m_SwipeDown;
        ...
        private void TickMouseClick()
        {
            ...
            if (CrossPlatformInput.GetMouseButtonDown(0)) {

                var inputPosition = CrossPlatformInput.MousePosition;
            ...
            if (!m_DetectSwipeOnlyAfterRelease && CrossPlatformInput.GetMouseButton(0)) {
            ...
            if (CrossPlatformInput.GetMouseButtonUp(0)) {
        ...
        {
            var note = m_RhythmProcessor.RhythmDirector.TrackObjects[trackInputEventData.TrackID].CurrentNote;
            trackInputEventData.Note = note;
    ...
    [Obsolete("This class is obsolete if you are not using the Legacy input manager, replace it by RhythmInputSystem or enable legacy input manager.")]
    public class RhythmInputManager : MonoBehaviour
    {
        [Header("This class is obsolete if you are not using the Legacy input manager, replace it by RhythmInputSystem or enable legacy input manager.")]
        [SerializeField] bool m_IgnoreThis = true;
    }
    */
}