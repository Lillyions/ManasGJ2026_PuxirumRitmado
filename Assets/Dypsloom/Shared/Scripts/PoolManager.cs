...
namespace Dypsloom.Shared.Utility
{
    ...
    #region Singleton Setup
        ...
        private Dictionary<EntityId, Stack<GameObject>> m_GameObjectPool = new Dictionary<EntityId, Stack<GameObject>>();
        private Dictionary<EntityId, EntityId> m_InstantiatedGameObjects = new Dictionary<EntityId, EntityId>();
    ...
    #region Instantiate
        ...
        protected virtual GameObject InstantiateInternal(GameObject original, Vector3 position, Quaternion rotation,
            Transform parent)
        {
            var originalInstanceID = original.GetEntityId();
            ...
            if (instantiatedObject == null) {
                ...
                m_InstantiatedGameObjects.Add(instantiatedObject.GetEntityId(), originalInstanceID);
            } else {
        ...
        /// <param name="parent">The parent of the instantiated game object.</param>
        /// <returns>The instantiated game object.</returns>
        protected virtual GameObject ObjectFromPool(EntityId originalInstanceID, Vector3 position, Quaternion rotation,
            Transform parent)
        {
    ...
    #region Getter
        ...
        {
            var instantiatedInstanceID = instantiatedObject.GetEntityId();
        ...
        /// <param name="objects">The array where the objects will be stored.</param>
        /// <returns>The amount of items in the array.</returns>
        protected virtual int GetObjectsFromPoolInternal(EntityId originalInstanceID, ref GameObject[] objects)
        {
            ...
            ref bool[] active)
        {
            ...
            for (int i = 0; i < count; i++) {
                ...
                active[i] = m_InstantiatedGameObjects.ContainsKey(instantiatedObject.GetEntityId());
            }
    ...
    #region Destroy
        ...
        {
            var instantiatedInstanceID = instantiatedObject.GetEntityId();
            var originalInstanceID = EntityId.None;
        ...
        private void DestroyLocal(GameObject instantiatedObject, EntityId originalInstanceID)
            {
